...
## Outputs
Table: [IDI_Sandpit].[DL-MAA2018-48].[defn_functional_disability_31_12_2018]
...
2022-12-21 VW Change to DL-MAA2018-48, IDI_Clean_202203, edit line 457 so get most recent record up to 2018-03-31, rename table to reflect: [IDI_Sandpit].[DL-MAA2018-48].[defn_functional_disability_31_12_2018]
...
DROP TABLE IF EXISTS [IDI_Sandpit].[DL-MAA2018-48].[defn_functional_disability_31_12_2018]
GO
...
single_person_source_date_record AS (
	...
	WHERE event_date <= '2018-12-31' -- edited 6.10.2023
...
INTO [IDI_Sandpit].[DL-MAA2018-48].[defn_functional_disability_31_12_2018]
FROM most_recent_date
WHERE ranking = 1
GO

CREATE NONCLUSTERED INDEX my_index_name ON [IDI_Sandpit].[DL-MAA2018-48].[defn_functional_disability_31_12_2018] (snz_uid);
GO
ALTER TABLE [IDI_Sandpit].[DL-MAA2018-48].[defn_functional_disability_31_12_2018] REBUILD PARTITION = ALL WITH (DATA_COMPRESSION = PAGE)
GO
